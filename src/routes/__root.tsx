...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Start your Norco College CTE journey here!" },
      ...
      { name: "twitter:description", content: "Start your Norco College CTE journey here!" },
    ...
    links: [
      ...
      { rel: "icon", href: "/favicon-square.png", type: "image/png" },
      { rel: "apple-touch-icon", href: "/favicon-square.png" },
    ],
  }),
